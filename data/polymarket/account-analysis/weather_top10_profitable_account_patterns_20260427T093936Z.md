# Polymarket météo — Top 10 comptes gagnants et patterns (20260427T093936Z)
...
|---:|---|---:|---:|---:|---|---:|
| 1 | gopfan2 | $344,909 | $4,571,405 | 7.54% | exact-bin / event-surface anomaly hunter | 1 / 16 |
...
| 4 | gopfan | $118,426 | $739,901 | 16.01% | sparse/large-ticket conviction trader | 24 / 0 |
| 5 | bama124 | $86,601 | $410,556 | 21.09% | weather-profitable generalist (current/recent flow mostly non-weather) | 0 / 0 |
| 6 | Hans323 | $80,872 | $6,971,547 | 1.16% | breadth/grid surface trader | 287 / 0 |
...
| 10 | BigMike11 | $62,777 | $850,756 | 7.38% | sparse/large-ticket conviction trader | 30 / 0 |

## Lecture transversale
- Styles top10: 1× exact-bin / event-surface anomaly hunter, 2× weather-profitable generalist (current/recent flow mostly non-weather), 3× breadth/grid surface trader, 3× sparse/large-ticket conviction trader, 1× weather-heavy signal/generalist.
...
## 1. gopfan2 — rank 1 — exact-bin / event-surface anomaly hunter
...
- Public récent: 1 trades météo, 16 positions météo actives, valeur active météo ~$4,881.23.
- Sizing visible: trade moyen météo récent ~$33.10, max ~$33.10.
- Notes pattern: présence d'exact bins/temp surfaces: chasse aux anomalies de grille ville/date; unit sizing plutôt petit: approche probe/multi-lignes plus copiable; activité publique récente mixte/non-weather: utile comme signal, pas pur spécialiste météo.
...
- Exemples positions actives:
  ...
  - $80.23: Will global temperature increase by less than 1.10ºC in April 2026?
  - $0.0: Will less than 12 named storms occur in the 2025 Atlantic hurricane season?
...
- Public récent: 451 trades météo, 414 positions météo actives, valeur active météo ~$29,406.69.
...
- Public récent: 24 trades météo, 0 positions météo actives, valeur active météo ~$0.00.
- Sizing visible: trade moyen météo récent ~$278.27, max ~$1,951.63.
...
- Public récent: 287 trades météo, 0 positions météo actives, valeur active météo ~$0.00.
- Sizing visible: trade moyen météo récent ~$706.88, max ~$22,909.19.
- Notes pattern: grand nombre de lignes: process/automatisation probable, diversification par surfaces; présence forte de thresholds: harvest de contrats 'or higher/below', souvent proche résolution; présence d'exact bins/temp surfaces: chasse aux anomalies de grille ville/date; tickets max élevés: conviction/banque significative, pas copiable tel quel.
- Exemples trades récents:
...
- Sizing visible: trade moyen météo récent ~$644.60, max ~$2,538.28.
- Notes pattern: présence d'exact bins/temp surfaces: chasse aux anomalies de grille ville/date; tickets max élevés: conviction/banque significative, pas copiable tel quel; activité publique récente mixte/non-weather: utile comme signal, pas pur spécialiste météo.
- Exemples trades récents:
  - SELL $3.4: August temperature increase by between 1.15-1.19°C?
  - SELL $7.5: August temperature increase by between 1.15-1.19°C?
  - BUY $924.43: August temperature increase by between 1.15-1.19°C?
  - BUY $585.47: August temperature increase by between 1.15-1.19°C?
  - BUY $587.76: August temperature increase by less than 1.15°C?
