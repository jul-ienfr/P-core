...
def build_resolution_source_route(
    ...
    *,
    ...
    if resolution.provider in _DIRECT_OFFICIAL_URL_PROVIDERS:
        if resolution.source_url:
            latency_priority = "direct_source_official_open_data" if resolution.provider in {"dwd", "bom", "jma", "pagasa", "imd", "meteoswiss", "smhi", "knmi", "aemet", "met_eireann", "dmi", "meteochile", "inmet", "senamhi_peru", "ideam_colombia", "smn_argentina", "smn_mexico", "south_african_weather_service", "nimet_nigeria", "egyptian_meteorological_authority", "israel_meteorological_service", "turkish_meteorological_service", "saudi_ncm", "kma_korea", "taiwan_cwa", "mss_singapore", "metmalaysia", "bmkg_indonesia", "tmd_thailand", "metservice_nz"} else "direct_source_low_latency"
